    ...
    <CommonContainerBox className={`px-4 py-4 ${className}`.trim()}>
      ...
      {goals.length === 0 ? (
        ...
        <div className="overflow-hidden rounded-lg border border-gray-200">
          <div className="grid grid-cols-[1.2fr_3fr_1.2fr_1fr_1fr_1fr_1fr] gap-3 border-b border-gray-100 bg-gray-50 px-4 py-2 text-sm font-semibold text-gray-600">
          ...
          <div className="divide-y divide-gray-100">
            {goals.map((goal) => (
              <div
                ...
                className="grid grid-cols-[1.2fr_3fr_1.2fr_1fr_1fr_1fr_1fr] gap-3 px-4 py-2 text-sm text-gray-700"
              >
          ...
          <div className="grid grid-cols-[1.5fr_3fr_1fr_1fr_1fr_1fr_1fr] gap-3 border-t border-gray-100 bg-gray-50 px-4 py-2 text-sm font-semibold text-gray-700">
            <span />
